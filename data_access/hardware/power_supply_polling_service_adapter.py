from business.domain.services.power_supply_polling_service import PowerSupplyPollingService
from business.domain.models.power_supply import PowerSupply
from data_access.hardware.power_supply_poller import PowerSupplyPoller
from PySide6.QtCore import QThread
from typing import Callable, Any


class PowerSupplyPollingServiceAdapter(PowerSupplyPollingService):
    def __init__(self):
        super().__init__()
