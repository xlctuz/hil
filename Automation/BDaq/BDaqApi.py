...
class TArray(object):
    ...
    def ToOutSignalType(nativeArr, autoFree):
        return TArray.ToEnum(nativeArr, autoFree, OutSignalType, Utils.toOutSignalType)
...
class TFmChannel(object):
    ...
    @staticmethod
    def getTimeUp(obj):
        dll.TFmChannel_getTimeup.restype = c_double
        dll.TFmChannel_getTimeup.argtypes = [c_uint64]
        return dll.TFmChannel_getTimeup(obj)

    @staticmethod
    def setTimeup(obj, value):
        dll.TFmChannel_setTimeup.argtypes = [c_uint64, c_double]
        return dll.TFmChannel_setTimeup(obj, c_double(value))
...
class TAbsChannel(object):
    @staticmethod
    def getChannel(obj):
        dll.TAbsChannel_getChannel.restype = c_int32
        dll.TAbsChannel_getChannel.argtypes = [c_uint64]
        return dll.TAbsChannel_getChannel(obj)

    @staticmethod
    def getNoiseFiltered(obj):
        dll.TAbsChannel_getNoiseFiltered.restype = c_int8
        dll.TAbsChannel_getNoiseFiltered.argtypes = [c_uint64]
        return dll.TAbsChannel_getNoiseFiltered(obj)

    @staticmethod
    def setNoiseFiltered(obj, value):
        dll.TAbsChannel_setNoiseFiltered.argtypes = [c_uint64, c_int8]
        return dll.TAbsChannel_setNoiseFiltered(obj, value)

    @staticmethod
    def getCodingType(obj):
        dll.TAbsChannel_getCodingType.argtypes = [c_uint64]
        return dll.TAbsChannel_getCodingType(obj)

    @staticmethod
    def setCodingType(obj, value):
        dll.TAbsChannel_setCodingType.argtypes = [c_uint64, c_int32]
        return dll.TAbsChannel_setCodingType(obj, value)

    @staticmethod
    def getBaudrate(obj):
        dll.TAbsChannel_getBaudrate.argtypes = [c_uint64]
        return dll.TAbsChannel_getBaudrate(obj)

    @staticmethod
    def setBaudrate(obj, value):
        dll.TAbsChannel_setBaudrate.argtypes = [c_uint64, c_int32]
        return dll.TAbsChannel_setBaudrate(obj, value)

    @staticmethod
    def getErrorRetType(obj):
        dll.TAbsChannel_getErrorRetType.argtypes = [c_uint64]
        return dll.TAbsChannel_getErrorRetType(obj)

    @staticmethod
    def setErrorRetType(obj, value):
        dll.TAbsChannel_setErrorRetType.argtypes = [c_uint64, c_int32]
        return dll.TAbsChannel_setErrorRetType(obj, value)

    @staticmethod
    def getErrorRetValue(obj):
        dll.TAbsChannel_getErrorRetValue.argtypes = [c_uint64]
        return dll.TAbsChannel_getErrorRetValue(obj)

    @staticmethod
    def setErrorRetValue(obj, value):
        dll.TAbsChannel_setErrorRetValue.argtypes = [c_uint64, c_int32]
        return dll.TAbsChannel_setErrorRetValue(obj, value)

    @staticmethod
    def getLatchSigEdge(obj):
        dll.TAbsChannel_getLatchSigEdge.argtypes = [c_uint64]
        return dll.TAbsChannel_getLatchSigEdge(obj)

    @staticmethod
    def setLatchSigEdge(obj, value):
        dll.TAbsChannel_setLatchSigEdge.argtypes = [c_uint64, c_int32]
        return dll.TAbsChannel_setLatchSigEdge(obj, value)

    @staticmethod
    def getOutSignal(obj):
        dll.TAbsChannel_getOutSignal.argtypes = [c_uint64]
        return dll.TAbsChannel_getOutSignal(obj)

    @staticmethod
    def setOutSignal(obj, value):
        dll.TAbsChannel_setOutSignal.argtypes = [c_uint64, c_int32]
        return dll.TAbsChannel_setOutSignal(obj, value)

    @staticmethod
    def getCompareValue0(obj):
        dll.TAbsChannel_getCompareValue0.argtypes = [c_uint64]
        return dll.TAbsChannel_getCompareValue0(obj)

    @staticmethod
    def setCompareValue0(obj, value):
        dll.TAbsChannel_setCompareValue0.argtypes = [c_uint64, c_int32]
        return dll.TAbsChannel_setCompareValue0(obj, value)

    @staticmethod
    def getCompare0Enabled(obj):
        dll.TAbsChannel_getCompare0Enabled.argtypes = [c_uint64]
        return dll.TAbsChannel_getCompare0Enabled(obj)

    @staticmethod
    def setCompare0Enabled(obj, value):
        dll.TAbsChannel_setCompare0Enabled.argtypes = [c_uint64, c_int32]
        return dll.TAbsChannel_setCompare0Enabled(obj, value)

    @staticmethod
    def getCompareValue1(obj):
        dll.TAbsChannel_getCompareValue1.argtypes = [c_uint64]
        return dll.TAbsChannel_getCompareValue1(obj)

    @staticmethod
    def setCompareValue1(obj, value):
        dll.TAbsChannel_setCompareValue1.argtypes = [c_uint64, c_int32]
        return dll.TAbsChannel_setCompareValue1(obj, value)

    @staticmethod
    def getCompare1Enabled(obj):
        dll.TAbsChannel_getCompare1Enabled.argtypes = [c_uint64]
        return dll.TAbsChannel_getCompare1Enabled(obj)

    @staticmethod
    def setCompare1Enabled(obj, value):
        dll.TAbsChannel_setCompare1Enabled.argtypes = [c_uint64, c_int32]
        return dll.TAbsChannel_setCompare1Enabled(obj, value)

class TAbsCounterCtrl(object):
    @staticmethod
    def getChannels(obj):
        dll.TAbsCounterCtrl_getChannels.argtypes = [c_uint64]
        dll.TAbsCounterCtrl_getChannels.restype = c_uint64
        return dll.TAbsCounterCtrl_getChannels(obj)

    @staticmethod
    def Read(obj, count, data):
        dll.TAbsCounterCtrl_Read.argtypes = [c_uint64, c_int32, POINTER(c_int32)]
        return dll.TAbsCounterCtrl_Read(obj, count, data)
