...
class ProjectConfigViewModel(QObject):
    ...
    def _configure_power_supply(self):
        ...
        try:
            ...
            # Open connection
            self.usecases.power_supply_adapter.open(temp_power_supply)
            ...
            try:
                ...
                for channel in power_supply.channels:
                    if channel.voltage is not None and channel.current is not None:
                        ...
                        self.usecases.power_supply_adapter.set_voltage_current(
                            temp_power_supply,
                ...
                self.usecases.power_supply_adapter.set_on_off(temp_power_supply, IO.ON)
            finally:
                # Close connection
                self.usecases.power_supply_adapter.close(temp_power_supply)
        except Exception as e:
    ...
    def _turn_off_power_supply(self):
        ...
        try:
            ...
            try:
                # Turn off power supply
                self.usecases.power_supply_adapter.set_on_off(temp_power_supply, IO.OFF)
            finally:
                # Close connection
                self.usecases.power_supply_adapter.close(temp_power_supply)
        except Exception as e:
