...
from infrastructure.persistence.database import Session, engine
from infrastructure.persistence.models.channel import Base as ChannelBase, Channel as ChannelORM
from infrastructure.persistence.models.project import Base as ProjectBase, Project as ProjectORM
from infrastructure.persistence.models.power_supply_it6302 import Base as PowerSupplyBase, Power_supply_it6302 as PowerSupplyORM, Power_supply_it6302_channel as PowerSupplyChannelORM
from infrastructure.persistence.models.pcie_1762h_controller import Base as Pcie1762hBase, Pcie_1762h as Pcie1762hORM, Pcie_1762h_do_channel as Pcie1762hDoChannelORM, Pcie_1762h_di_channel as Pcie1762hDiChannelORM
            ...
            if project.pcie_1762h:
                ...
                for i, do_ch in enumerate(pcie.do_channels):
                    if i < len(pcie_orm.do_channels):
                        ...
                        if do_ch.status:
                            from infrastructure.persistence.models.pcie_1762h_controller import Status as ORMSatus
