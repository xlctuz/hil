from domain.services.power_supply_polling_service import PowerSupplyPollingService
from domain.models.power_supply import PowerSupply
from infrastructure.hardware.power_supply_poller import PowerSupplyPoller
